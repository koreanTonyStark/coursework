...
/*----------------------------------------------------------------------------
 * Before Entering Code, all part is same as hw1 (which is Baker-Bird Alg)
 * The key difference is that, Given input make the answer_array and check it 
 * with the given output(for check), if it matches, then compute say yes, 
 * if not, then say no.
 *---------------------------------------------------------------------------*/
...
/* Function : main 
 * Description : File IO, execute Baker-Bird alg and compare answer array with the given output(use for check)
 */
